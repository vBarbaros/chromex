...
@Component({
  ...
  selector: 'app-worth-it-calculator',
  templateUrl: './worth-it-calculator.component.html',
  styleUrls: ['./worth-it-calculator.component.css']
})
export class WorthItCalculatorComponent implements OnInit {
